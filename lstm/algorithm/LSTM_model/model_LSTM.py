...
def load_data():
    ...
    # data = np.load("./lstm/data/data_for_model.npz", allow_pickle=True)
    x = data["x"]
    y = data["y"]
    return x, y
...
def train_net(n_neurouse, n_layers, drop_rate, hidden_size,Mini_batch,
              Active_function,Optimizer,Learning_rate):
